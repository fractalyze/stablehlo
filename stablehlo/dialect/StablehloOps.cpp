...
#define INFER_RETURN_TYPE_COMPONENTS_FROM_OPERANDS(Op)                \
  ...
  LogicalResult GatherOp::verify() {
    return hlo::verifyGatherOp(
        getLoc(), getOperand(), getStartIndices(),
        getDimensionNumbers().getOffsetDims(),
        getDimensionNumbers().getCollapsedSliceDims(),
        getDimensionNumbers().getOperandBatchingDims(),
        getDimensionNumbers().getStartIndicesBatchingDims(),
        getDimensionNumbers().getStartIndexMap(),
        getDimensionNumbers().getIndexVectorDim(), getSliceSizes());
  }
...
namespace mlir::stablehlo
{
      ...
      : Dialect(getDialectNamespace(), context, TypeID::get<StablehloDialect>())
  {
    addOperations<
#define GET_OP_LIST
#include "stablehlo/dialect/StablehloOps.cpp.inc" // NOLINT(build/include)
        >();
...
#include "stablehlo/dialect/StablehloAttrs.cpp.inc" // NOLINT(build/include)
        >();
  }
