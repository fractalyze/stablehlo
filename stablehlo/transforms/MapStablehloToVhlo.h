...
#ifndef STABLEHLO_TRANSFORMS_MAPSTABLEHLOTOVHLO_H_
#define STABLEHLO_TRANSFORMS_MAPSTABLEHLOTOVHLO_H_
...
// TODO(chokobole): Uncomment this. Dependency: AfterAllOpV1
// MAP_STABLEHLO_TO_VHLO(AfterAllOp, V1)
// TODO(chokobole): Uncomment this. Dependency: AllGatherOpV2
// MAP_STABLEHLO_TO_VHLO(AllGatherOp, V2)
// TODO(chokobole): Uncomment this. Dependency: AllReduceOpV2
// MAP_STABLEHLO_TO_VHLO(AllReduceOp, V2)
// TODO(chokobole): Uncomment this. Dependency: AllToAllOpV2
// MAP_STABLEHLO_TO_VHLO(AllToAllOp, V2)
MAP_STABLEHLO_TO_VHLO(AndOp, V1)
MAP_STABLEHLO_TO_VHLO(BitcastConvertOp, V1)
MAP_STABLEHLO_TO_VHLO(BitReverseOp, V1)
...
// TODO(chokobole): Uncomment this. Dependency: CollectiveBroadcastOpV1
// MAP_STABLEHLO_TO_VHLO(CollectiveBroadcastOp, V1)
// TODO(chokobole): Uncomment this. Dependency: CollectivePermuteOpV1
// MAP_STABLEHLO_TO_VHLO(CollectivePermuteOp, V1)
MAP_STABLEHLO_TO_VHLO(CompareOp, V1)
// TODO(chokobole): Uncomment this. Dependency: CompositeOpV1
...
// TODO(chokobole): Uncomment this. Dependency: DynamicGatherOpV2
...
// TODO(chokobole): Uncomment this. Dependency: InfeedOpV1
...
// TODO(chokobole): Uncomment this. Dependency: SelectAndScatterOpV1
// MAP_STABLEHLO_TO_VHLO(SelectAndScatterOp, V1)
MAP_STABLEHLO_TO_VHLO(SelectOp, V1)
// TODO(chokobole): Uncomment this. Dependency: SendOpV1
...
// TODO(chokobole): Uncomment this. Dependency: UnaryEinsumOp
...
#endif // STABLEHLO_TRANSFORMS_MAPSTABLEHLOTOVHLO_H_
